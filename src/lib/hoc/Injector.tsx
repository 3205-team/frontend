...
export function diInject<P extends I, I, C, K = any>(
    ...
    class DiInjectClass extends Component<Props> {
        ...
        public static displayName = `diInject(${getDisplayName(component)})`
        ...
        private inject = () => {
            ...
            (Object.keys(dependencies) as (keyof I)[]).forEach((key) => {
                ...
                // @ts-ignore
                result[key] = deps.options && deps.options.transformation ? deps.options.transformation(instance) : instance;
            })
        ...
        public render() {
            ...
            return <WrappedComponent {...injections} {...(this.props as any)}/>
        }
    }
